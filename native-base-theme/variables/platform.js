...
export default {
  ...
  // CheckBox
  CheckboxRadius: platform === PLATFORM.IOS ? 13 : 5,
  ...
  checkboxBgColor: 'grey',
  checkboxSize: platform === PLATFORM.IOS ? 20 : 22,
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#105DCD',
  footerPaddingBottom: 0,

  // FooterTab
  tabBarTextColor: platform === PLATFORM.IOS ? '#6b6b6b' : '#b3c7f9',
  tabBarTextSize: platform === PLATFORM.IOS ? 14 : 11,
  activeTab: platform === PLATFORM.IOS ? '#105DCD' : '#fff',
  sTabBarActiveTextColor: '#105DCD',
  tabBarActiveTextColor: platform === PLATFORM.IOS ? '#105DCD' : '#fff',
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : '#105DCD',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#105DCD' : '#fff',
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#105DCD',
  toolbarHeight: platform === PLATFORM.IOS ? 64 : 56,
  toolbarSearchIconSize: platform === PLATFORM.IOS ? 20 : 23,
  toolbarInputColor: platform === PLATFORM.IOS ? '#CECDD2' : '#fff',
  searchBarHeight: platform === PLATFORM.IOS ? 30 : 40,
  searchBarInputHeight: platform === PLATFORM.IOS ? 30 : 50,
  toolbarBtnTextColor: platform === PLATFORM.IOS ? '#105DCD' : '#fff',
  toolbarDefaultBorder: platform === PLATFORM.IOS ? '#a7a6ab' : '#105DCD',
  ...
  listItemSelected: platform === PLATFORM.IOS ? '#105DCD' : '#105DCD',
  ...
  radioSelectedColorAndroid: '#105DCD',
  ...
  // Segment
  segmentBackgroundColor: platform === PLATFORM.IOS ? '#F8F8F8' : '#105DCD',
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? '#105DCD' : '#fff',
  segmentTextColor: platform === PLATFORM.IOS ? '#105DCD' : '#fff',
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : '#105DCD',
  segmentBorderColor: platform === PLATFORM.IOS ? '#105DCD' : '#fff',
  segmentBorderColorMain: platform === PLATFORM.IOS ? '#a7a6ab' : '#105DCD',

  // Spinner
  defaultSpinnerColor: '#105DCD',
  inverseSpinnerColor: '#105DCD',

  // Tab
  tabBarDisabledTextColor: '#BDBDBD',
  tabDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#105DCD',
  topTabBarTextColor: platform === PLATFORM.IOS ? '#6b6b6b' : '#b3c7f9',
  topTabBarActiveTextColor: platform === PLATFORM.IOS ? '#105DCD' : '#fff',
  topTabBarBorderColor: platform === PLATFORM.IOS ? '#a7a6ab' : '#fff',
  topTabBarActiveBorderColor: platform === PLATFORM.IOS ? '#105DCD' : '#fff',
  ...
  // Other
  borderRadiusBase: platform === PLATFORM.IOS ? 25 : 25,
